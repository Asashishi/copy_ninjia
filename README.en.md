...
<tr><td>🚦&nbsp;Per-group concurrency</td><td>At most one Gemini tool conversation may be in flight per group. Direct triggers enter a bounded queue while a round is active; random triggers are dropped</td></tr>
