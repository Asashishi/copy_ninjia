...
<tr><td>🚦&nbsp;Per-group concurrency</td><td>At most ten Gemini tool conversations may be in flight per group. When all concurrency slots are occupied, direct triggers enter a queue capped at 25 items and random triggers are dropped</td></tr>
