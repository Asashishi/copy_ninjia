...
<p align="center">
  ...
  <a href="docs/en/05-dev-workflow.md"><img src="https://img.shields.io/badge/Tests-1657_Passed-2ea44f?style=flat-square" alt="Tests"></a>
...
<p align="center">
  <picture>
    ...
    <img alt="bun run test:coverage — 1657 tests passed, 171 test files, 30,450 expect() calls, 95.53% function coverage, 96.61% line coverage" src="docs/assets/coverage_light.svg" width="780">
  </picture>
</p>
