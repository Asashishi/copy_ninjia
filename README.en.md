...
<p align="center">
  ...
  <a href="docs/en/05-dev-workflow.md"><img src="https://img.shields.io/badge/Tests-1591_Passed-2ea44f?style=flat-square" alt="Tests"></a>
...
<p align="center">
  <picture>
    ...
    <img alt="bun run test:coverage — 1591 tests passed, 169 test files, 30,060 expect() calls, 95.16% function coverage, 96.56% line coverage" src="docs/assets/coverage_light.svg" width="780">
  </picture>
</p>
