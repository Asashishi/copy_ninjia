...
<p align="center">
  ...
  <a href="docs/05-dev-workflow.md"><img src="https://img.shields.io/badge/Tests-1032_Passed-2ea44f?style=flat-square" alt="Tests"></a>
  <a href="docs/05-dev-workflow.md"><img src="https://img.shields.io/badge/Coverage-96.46%25-2ea44f?style=flat-square" alt="Coverage"></a>
...
<p align="center">
  <picture>
    ...
    <img alt="bun run test:coverage：1032 项测试全部通过 / 132 个测试文件 / 8,870 次 expect() 调用 / 函数覆盖率 94.44% / 行覆盖率 96.46%" src="docs/assets/coverage_light.svg" width="780">
  </picture>
</p>
