...
<p align="center">
  ...
  <a href="docs/05-dev-workflow.md"><img src="https://img.shields.io/badge/Tests-849_Passed-2ea44f?style=flat-square" alt="Tests"></a>
  <a href="docs/05-dev-workflow.md"><img src="https://img.shields.io/badge/Coverage-95.95%25-2ea44f?style=flat-square" alt="Coverage"></a>
...
| 🗺️ **源码导览** | `src/` 各子领域的职责分工与代码放置决策树 | [📖 03 目录导览](docs/03-directory-map.md) |
