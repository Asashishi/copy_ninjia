...
<p align="center">
  ...
  <a href="docs/05-dev-workflow.md"><img src="https://img.shields.io/badge/Tests-1051_Passed-2ea44f?style=flat-square" alt="Tests"></a>
...
<p align="center">
  <picture>
    ...
    <img alt="bun run test:coverage：1051 项测试全部通过 / 132 个测试文件 / 8,923 次 expect() 调用 / 函数覆盖率 94.46% / 行覆盖率 96.47%" src="docs/assets/coverage_light.svg" width="780">
  </picture>
</p>
