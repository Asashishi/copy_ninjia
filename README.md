...
<p align="center">
  ...
  <a href="docs/cn/05-dev-workflow.md"><img src="https://img.shields.io/badge/Tests-2876_Passed-2ea44f?style=flat-square" alt="Tests"></a>
...
<p align="center">
  <picture>
    ...
    <img alt="bun run test:coverage：2876 项测试全部通过 / 294 个测试文件 / 96,444 次 expect() 调用 / 函数覆盖率 96.28% / 行覆盖率 97.19%" src="pictures/coverage_light.svg" width="780">
  </picture>
</p>
