...
<p align="center">
  ...
  <a href="docs/cn/05-dev-workflow.md"><img src="https://img.shields.io/badge/Tests-4190_Passed-2ea44f?style=flat-square" alt="Tests"></a>
...
<p align="center">
  <picture>
    ...
    <img alt="bun run test:coverage：4190 项测试全部通过 / 370 个测试文件 / 156,432 次 expect() 调用 / 函数覆盖率 97.56% / 行覆盖率 97.76%" src="pictures/coverage_light.svg" width="780">
  </picture>
</p>
