...
<p align="center">
  ...
  <a href="docs/cn/05-dev-workflow.md"><img src="https://img.shields.io/badge/Tests-3025_Passed-2ea44f?style=flat-square" alt="Tests"></a>
...
<p align="center">
  <picture>
    ...
    <img alt="bun run test:coverage：3025 项测试全部通过 / 310 个测试文件 / 97,583 次 expect() 调用 / 函数覆盖率 96.59% / 行覆盖率 97.16%" src="pictures/coverage_light.svg" width="780">
  </picture>
</p>
