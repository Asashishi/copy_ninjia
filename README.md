...
<p align="center">
  ...
  <a href="docs/cn/05-dev-workflow.md"><img src="https://img.shields.io/badge/Tests-4194_Passed-2ea44f?style=flat-square" alt="Tests"></a>
  <a href="docs/cn/05-dev-workflow.md"><img src="https://img.shields.io/badge/Coverage-97.79%25-2ea44f?style=flat-square" alt="Coverage"></a>
...
<p align="center">
  <picture>
    ...
    <img alt="bun run test:coverage：4194 项测试全部通过 / 373 个测试文件 / 156,885 次 expect() 调用 / 函数覆盖率 97.64% / 行覆盖率 97.79%" src="pictures/coverage_light.svg" width="780">
  </picture>
</p>
