...
<p align="center">
  ...
  <a href="docs/ja/05-dev-workflow.md"><img src="https://img.shields.io/badge/Tests-1051_Passed-2ea44f?style=flat-square" alt="Tests"></a>
...
<p align="center">
  <picture>
    ...
    <img alt="bun run test:coverage — 1051 件のテストが全て成功 / テストファイル 132 件 / expect() 呼び出し 8,923 回 / 関数カバレッジ 94.46% / 行カバレッジ 96.47%" src="docs/assets/coverage_light.svg" width="780">
  </picture>
</p>
