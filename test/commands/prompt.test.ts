...
beforeEach(() => { state.isInitEnabled = true; state.aiPersona = undefined; allowed = false; send.mockClear(); syncPersona.mockClear(); syncAtmosphere.mockClear(); syncMenu.mockClear(); persist.mockReset(); persist.mockResolvedValue(undefined); });
