...
const messages: readonly RevisionedMessage[] = [
  ...
  { aiPersona: null, type: "chatStateWrite", chatId: -7, data: null, revision: 2 },
...
test("每个 SQLite 领域独立按主键覆盖旧 revision，保留镜像后的新值", (): void => {
  ...
  expect(revisions.covers({ aiPersona: null, type: "chatStateWrite", chatId: -8, data: null, revision: 1 })).toBeFalse();
});
