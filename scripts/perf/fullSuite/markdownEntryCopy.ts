...
const ZH: BenchmarkEntryCopy = {
  labels: {
    ...
    "temporary-whitelist-activity": "推进临时白名单日内活动与授权边沿",
...
const EN: BenchmarkEntryCopy = {
  labels: {
    ...
    "temporary-whitelist-activity": "Advance temporary-allowlist activity and its grant edge",
...
const JA: BenchmarkEntryCopy = {
  labels: {
    ...
    "temporary-whitelist-activity": "一時 allowlist の日内活動と付与境界を進める",
