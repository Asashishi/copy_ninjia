...
const ZH: BenchmarkEntryCopy = {
  labels: {
    ...
    "ai-media-direct-trigger": "AI 开启后一条直接唤起的媒体消息构造触发上下文与记录载荷",
...
const EN: BenchmarkEntryCopy = {
  labels: {
    ...
    "ai-media-direct-trigger": "Build the trigger context and record payload for one directly addressed media message",
...
const JA: BenchmarkEntryCopy = {
  labels: {
    ...
    "ai-media-direct-trigger": "直接呼びかけられたメディア 1 件のトリガー文脈と記録ペイロードを構築する",
