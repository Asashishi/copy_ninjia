...
const ZH: BenchmarkEntryCopy = {
  labels: {
    ...
    "linked-timestamp-window": "无配额上限的滑动时间窗口追加与过期淘汰",
...
const EN: BenchmarkEntryCopy = {
  labels: {
    ...
    "linked-timestamp-window": "Append to and expire an uncapped sliding timestamp window",
...
const JA: BenchmarkEntryCopy = {
  labels: {
    ...
    "linked-timestamp-window": "上限なし時刻スライディングウィンドウの追加と期限切れ削除",
