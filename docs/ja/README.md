...
<p align="center">
  <picture>
    ...
    <img alt="bun run test:coverage — 4480 件のテストが全て成功 / テストファイル 384 件 / expect() 呼び出し 158,742 回 / 関数カバレッジ 97.22% / 行カバレッジ 98.01%" src="../../pictures/coverage_light.svg" width="780">
  </picture>
</p>
