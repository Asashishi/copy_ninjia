...
<p align="center">
  <picture>
    ...
    <img alt="bun run test:coverage — 4209 件のテストが全て成功 / テストファイル 375 件 / expect() 呼び出し 157,298 回 / 関数カバレッジ 96.97% / 行カバレッジ 97.89%" src="../../pictures/coverage_light.svg" width="780">
  </picture>
</p>
