...
<p align="center">
  <picture>
    ...
    <img alt="bun run test:coverage — 4194 件のテストが全て成功 / テストファイル 373 件 / expect() 呼び出し 156,885 回 / 関数カバレッジ 97.64% / 行カバレッジ 97.79%" src="../../pictures/coverage_light.svg" width="780">
  </picture>
</p>
