...
<p align="center">
  <picture>
    ...
    <img alt="bun run test:coverage — 4180 件のテストが全て成功 / テストファイル 370 件 / expect() 呼び出し 156,432 回 / 関数カバレッジ 97.56% / 行カバレッジ 97.76%" src="../../pictures/coverage_light.svg" width="780">
  </picture>
</p>
