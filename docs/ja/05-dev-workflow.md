...
`bun run test:coverage`：**3029 tests / 310 files / 97593 `expect()` calls**。全ソースコードの**関数カバレッジは 96.59%、行カバレッジは 97.16%**です。3 言語の各プロジェクト README の Coverage badge は行カバレッジを表示します。
