...
`bun run test:coverage`: **1532 tests / 166 files / 27514 `expect()` calls**; full-source **function coverage 95.29% / line coverage 96.61%**. The root README's Coverage badge displays line coverage.
