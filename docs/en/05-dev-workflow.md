...
`bun run test:coverage`: **4290 tests / 380 files / 157750 `expect()` calls**; full-source **function coverage 97.17% / line coverage 97.93%**. The Coverage badge in each project README displays line coverage.
