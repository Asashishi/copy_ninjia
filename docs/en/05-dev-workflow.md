...
`bun run test:coverage`: **907 tests / 123 files / 8505 `expect()` calls**; full-source **function coverage 94.65% / line coverage 96.60%**. The root README's Coverage badge displays line coverage.
