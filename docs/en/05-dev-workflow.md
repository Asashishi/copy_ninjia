...
`bun run test:coverage`: **3513 tests / 347 files / 129700 `expect()` calls**; full-source **function coverage 97.21% / line coverage 97.45%**. The Coverage badge in each project README displays line coverage.
