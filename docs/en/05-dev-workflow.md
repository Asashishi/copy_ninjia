...
`bun run test:coverage`: **3817 tests / 357 files / 157155 `expect()` calls**; full-source **function coverage 97.39% / line coverage 97.65%**. The Coverage badge in each project README displays line coverage.
