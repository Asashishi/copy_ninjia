...
`bun run test:coverage`: **1554 tests / 167 files / 27602 `expect()` calls**; full-source **function coverage 95.08% / line coverage 96.51%**. The root README's Coverage badge displays line coverage.
