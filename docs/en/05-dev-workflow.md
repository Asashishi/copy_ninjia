...
`bun run test:coverage`: **1657 tests / 171 files / 30450 `expect()` calls**; full-source **function coverage 95.53% / line coverage 96.61%**. The root README's Coverage badge displays line coverage.
