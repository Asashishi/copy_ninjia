...
`bun run test:coverage`: **4190 tests / 370 files / 156432 `expect()` calls**; full-source **function coverage 97.56% / line coverage 97.76%**. The Coverage badge in each project README displays line coverage.
