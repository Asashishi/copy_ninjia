...
`bun run test:coverage`: **4209 tests / 375 files / 157298 `expect()` calls**; full-source **function coverage 96.97% / line coverage 97.89%**. The Coverage badge in each project README displays line coverage.
