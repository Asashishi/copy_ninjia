...
`bun run test:coverage`: **1032 tests / 132 files / 8870 `expect()` calls**; full-source **function coverage 94.44% / line coverage 96.46%**. The root README's Coverage badge displays line coverage.
