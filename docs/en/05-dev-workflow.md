...
`bun run test:coverage`: **1581 tests / 169 files / 29945 `expect()` calls**; full-source **function coverage 95.15% / line coverage 96.54%**. The root README's Coverage badge displays line coverage.
