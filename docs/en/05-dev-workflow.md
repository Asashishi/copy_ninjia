...
`bun run test:coverage`: **1679 tests / 172 files / 30519 `expect()` calls**; full-source **function coverage 95.56% / line coverage 96.63%**. The root README's Coverage badge displays line coverage.
