...
`bun run test:coverage`: **4194 tests / 373 files / 156885 `expect()` calls**; full-source **function coverage 97.64% / line coverage 97.79%**. The Coverage badge in each project README displays line coverage.
