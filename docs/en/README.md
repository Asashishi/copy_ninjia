...
<p align="center">
  <picture>
    ...
    <img alt="bun run test:coverage — 2361 tests passed, 246 test files, 94,774 expect() calls, 94.86% function coverage, 95.59% line coverage" src="../../pictures/coverage_light.svg" width="780">
  </picture>
</p>
