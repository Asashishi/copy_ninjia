...
<p align="center">
  ...
  <a href="05-dev-workflow.md"><img src="https://img.shields.io/badge/Tests-4190_Passed-2ea44f?style=flat-square" alt="Tests"></a>
...
<p align="center">
  <picture>
    ...
    <img alt="bun run test:coverage — 4190 tests passed, 370 test files, 156,432 expect() calls, 97.56% function coverage, 97.76% line coverage" src="../../pictures/coverage_light.svg" width="780">
  </picture>
</p>
