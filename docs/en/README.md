...
<p align="center">
  <picture>
    ...
    <img alt="bun run test:coverage — 2414 tests passed, 254 test files, 94,976 expect() calls, 94.61% function coverage, 95.40% line coverage" src="../../pictures/coverage_light.svg" width="780">
  </picture>
</p>
