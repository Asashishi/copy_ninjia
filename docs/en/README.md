...
<p align="center">
  <picture>
    ...
    <img alt="bun run test:coverage — 3509 tests passed, 346 test files, 129,696 expect() calls, 97.21% function coverage, 97.45% line coverage" src="../../pictures/coverage_light.svg" width="780">
  </picture>
</p>
