...
<p align="center">
  ...
  <a href="05-dev-workflow.md"><img src="https://img.shields.io/badge/Tests-4209_Passed-2ea44f?style=flat-square" alt="Tests"></a>
...
<p align="center">
  <picture>
    ...
    <img alt="bun run test:coverage — 4209 tests passed, 375 test files, 157,298 expect() calls, 96.97% function coverage, 97.89% line coverage" src="../../pictures/coverage_light.svg" width="780">
  </picture>
</p>
