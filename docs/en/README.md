...
<p align="center">
  <picture>
    ...
    <img alt="bun run test:coverage — 3865 tests passed, 363 test files, 157,287 expect() calls, 97.54% function coverage, 97.7% line coverage" src="../../pictures/coverage_light.svg" width="780">
  </picture>
</p>
