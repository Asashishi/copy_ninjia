...
<p align="center">
  <picture>
    ...
    <img alt="bun run test:coverage — 2245 tests passed, 234 test files, 32,766 expect() calls, 95.66% function coverage, 96.62% line coverage" src="../../pictures/coverage_light.svg" width="780">
  </picture>
</p>
